...
/*   Updated: 2023/07/01 00:36:16 by mschulme         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char **av, char **env)
{
	...
	data->av = av;
	data->envp = env;
	init_env_unsorted(data, env); // Add new values at the end??
	init_env_sorted(data, env);  // ToDo! Add new values at the correct position!!!
