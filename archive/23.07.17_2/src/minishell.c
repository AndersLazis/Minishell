...
/*   Updated: 2023/07/17 20:01:42 by aputiev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	shell_loop(t_data *data)
{
	...
	while (1)
	{
		...
		if(heredoc_exist(command_line, data))	//<----------------------------------------------added 17.07.2023
			command_line = handle_heredoc(command_line, data);	//<------------------------------added 17.07.2023
