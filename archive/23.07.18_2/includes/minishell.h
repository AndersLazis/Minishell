...
/*   Updated: 2023/07/18 21:12:24 by aputiev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct s_data
{
	...
	int			save_in;
	int			save_out;
	int			heredoc_flag;	//<-changed_19.07.2023
	char		*heredoc_EOF;	//<-changed_19.07.2023
	char		*heredoc_filename;	//<-changed_19.07.2023
