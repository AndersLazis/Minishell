...
/*   Updated: 2023/07/23 19:00:34 by aputiev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_exit(t_data *data, int exit_code);	//<-changed_23.07.23
void	ft_env(t_data *data);
int		ft_cd(t_data *data);
void	ft_echo(t_data*data);
int		ft_pwd();
void	ft_unset(t_data *data);
void	ft_dollar_question_mark(t_data *data);
