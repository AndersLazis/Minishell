...
/*   Updated: 2023/07/25 12:52:23 by aputiev          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	increment_shell_level(t_data *data)
{
	...
	if(sh_lvl_var_unsorted->value)	//<-changed_23.07.25
		free(sh_lvl_var_unsorted->value);	//<-changed_23.07.25
	if(sh_lvl_var_sorted->value)	//<-changed_23.07.25
		free(sh_lvl_var_sorted->value);	//<-changed_23.07.25
